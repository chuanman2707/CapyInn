...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::assistant::get_assistant_settings,
            commands::assistant::set_assistant_settings,
            commands::assistant::set_assistant_api_key,
            commands::assistant::clear_assistant_api_key,
            commands::assistant::set_assistant_cloud_opt_in,
            commands::assistant_conversations::list_assistant_conversations,
            commands::assistant_conversations::get_assistant_conversation,
            commands::assistant_conversations::delete_assistant_conversation,
            commands::assistant_conversations::delete_all_assistant_conversations,
